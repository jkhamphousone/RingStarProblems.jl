...
\begin{itemize}
	\item  $F = [0.0,11.4285714286,14.6665791467,178.400105024,266.6666666667,325.7142857143,623.3333333333]$
 \item $B = [7.1,5.35,3.85,2.6,2.45,1.75,0.85]$
 \item  $K = [1509.0,1529.0,1550.99986872,1774.0,1814.0,2042.0,2603.0]$\item Total execution time is: 259.26s\item Number of times BBC is called: 13\end{itemize}\end{document}