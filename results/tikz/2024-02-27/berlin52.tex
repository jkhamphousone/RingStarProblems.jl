...
\begin{figure}[ht!]
    ...
    \draw[axe](0,0) -- (0.0,0);
     \draw[axe](0,0) -- (0,248.8860000000000277);\draw (\F[0],0) -- (\F[0],-.2);
...
\begin{itemize}
	\item  $F = [0.0,0.0]$
 \item $B = [21.18,1.38]$
 \item  $K = [22626.0,22626.0]$\item Total execution time is: 20.09s\item Number of times BBC is called: 2\end{itemize}\end{document}