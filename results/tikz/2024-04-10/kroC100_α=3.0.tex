...
%     \draw[axe](0,0) -- (0.0,0);
%      \draw[axe](0,0) -- (0,684.7170000000001);\draw (\F[0],0) -- (\F[0],-.2);
...
%     \node (g) at (2,684.7170000000001){}; \draw(g) node{$g(F)$};
%     % Lines
...
%     \end{tikzpicture}
    \end{center}
    \vspace*{-2eM}
    \caption{$g(F)$ for the kroC100 instance}\label{fig:1}
    \end{figure}
...
\begin{itemize}
	\item  $F = [0.0]$
 \item $B = [23.7]$
 \item  $K = [62247.0]$\item Total execution time is: 276.32s\item Number of times BBC is called: 2\end{itemize}\end{document}