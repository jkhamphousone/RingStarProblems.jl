...
%     \draw[axe](0,0) -- (0.0,0);
%      \draw[axe](0,0) -- (0,702.7020000000001);\draw (\F[0],0) -- (\F[0],-.2);
...
%     \node (g) at (2,702.7020000000001){}; \draw(g) node{$g(F)$};
%     % Lines
...
\begin{itemize}
	\item  $F = [0.0]$
 \item $B = [27.72]$
 \item  $K = [63882.0]$\item Total execution time is: 110.2s\item Number of times BBC is called: 2\end{itemize}\end{document}