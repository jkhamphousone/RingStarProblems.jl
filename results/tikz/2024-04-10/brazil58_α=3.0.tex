...
\begin{figure}[ht!]
    \begin{center}
%    \begin{tikzpicture}[scale=.2, xscale=.2cm, yscale=.2cm]
...
\begin{itemize}
 ...
 \item $B = [114.9,94.26]$
 \item  $K = [76185.0,76200.0]$\item Total execution time is: 134.6s\item Number of times BBC is called: 4\end{itemize}\end{document}
