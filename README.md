...
julia> using GLPK
julia> id_instance = 3
julia> rspoptimize(pars, id_instance, optimizer_with_attributes(GLPK.Optimizer,
...
```julia
julia> using Gurobi
julia> rspoptimize(pars, id_instance, optimizer_with_attributes(Gurobi.Optimizer,
