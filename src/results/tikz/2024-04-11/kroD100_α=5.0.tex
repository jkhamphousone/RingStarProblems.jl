...
%     \draw[axe](0,0) -- (0.0,0);
%      \draw[axe](0,0) -- (0,1118.095);\draw (\F[0],0) -- (\F[0],-.2);
...
%     \node (g) at (2,1118.095){}; \draw(g) node{$g(F)$};
%     % Lines
...
\begin{itemize}
	\item  $F = [0.0]$
 \item $B = [46.9]$
 \item  $K = [101645.0]$\item Total execution time is: 214.89s\item Number of times BBC is called: 2\end{itemize}\end{document}