...
\begin{figure}[ht!]
    ...
    \draw[axe](0,0) -- (7.249999999999956,0);
...
\node (F) at (9.249999999999956,2){}; \draw(F) node{$F$};
...
\begin{itemize}
 ...
 \item  $K = [1047.0,1104.0,1586.0,3103.0,3190.0]$\item Total execution time is: 197.07s\item Number of times BBC is called: 10\end{itemize}\end{document}