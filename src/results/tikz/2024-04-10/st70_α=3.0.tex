...
%     \draw[axe](0,0) -- (0.0,0);
%      \draw[axe](0,0) -- (0,22.275000000000002);\draw (\F[0],0) -- (\F[0],-.2);
...
%     \node (g) at (2,22.275000000000002){}; \draw(g) node{$g(F)$};
%     % Lines
...
\begin{itemize}
	\item  $F = [0.0]$
 \item $B = [0.96]$
 \item  $K = [2025.0]$\item Total execution time is: 44.8s\item Number of times BBC is called: 2\end{itemize}\end{document}