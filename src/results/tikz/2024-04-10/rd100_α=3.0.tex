...
%     \draw[axe](0,0) -- (0.0,0);
%      \draw[axe](0,0) -- (0,261.03000000000003);\draw (\F[0],0) -- (\F[0],-.2);
...
%     \node (g) at (2,261.03000000000003){}; \draw(g) node{$g(F)$};
%     % Lines
...
\begin{itemize}
	\item  $F = [0.0]$
 \item $B = [9.69]$
 \item  $K = [23730.0]$\item Total execution time is: 99.35s\item Number of times BBC is called: 2\end{itemize}\end{document}