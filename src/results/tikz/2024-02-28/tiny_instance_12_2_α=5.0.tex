\documentclass{article}
     ...
     \date{2024-02-28}
     \maketitle
     \def\F{{0.0001,0.1142857143,0.1466666667,3.5066666667,3.8573333333}}
\def\gF{{15.09071,15.9014285714,16.0746666667,29.0106666667,2605.980666666667}}
\begin{figure}[ht!]
    \begin{center}
    ...
    \draw[axe](0,0) -- (0.8766666666666656,0);
     \draw[axe](0,0) -- (0,31.9117333333777);\draw (\F[0],0) -- (\F[0],-.2);
...
\node (F) at (2.8766666666666656,2){}; \draw(F) node{$F$};
    \node (g) at (2,31.91173333337){}; \draw(g) node{$g(F)$};
    % Lines
...
\begin{itemize}
	\item  $F = [0.01,11.4285714286,14.6666666667,350.6666666667]$
 \item $B = [7.1,5.35,3.85,0.85]$
 \item  $K = [1509.0,1529.0,1551.0,2603.0]$\item Total execution time is: 50.63s\item Number of times BBC is called: 7\end{itemize}\end{document}